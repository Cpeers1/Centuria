package org.asf.centuria.social;

import org.asf.centuria.social.impl.FileBasedSocialManager;
...
public abstract class SocialManager {
	...
	/**
	 * Retrieves the list entries of the players who this player has social contacts
	 * with.
	 * 
	 * @param playerID ID for the main player (friend list owner)
	...
	/**
	 * Gets if the player (by the player id to check) is in the players following
	 * list.
	 * 
	 * @param sourcePlayerID ID for the main player (friend list owner)
	 * @param targetPlayerID ID for the target player.
	 * @return A boolean value representing whether the main player has the target
	 *         player in their following list.
	 */
	public abstract boolean getPlayerIsFollowing(String sourcePlayerID, String targetPlayerID);

	/**
	 * Gets if the player (by the player id to check) is in the players followers
	 * list.
	 * 
	 * @param sourcePlayerID ID for the main player (friend list owner)
	 * @param targetPlayerID ID for the target player.
	 * @return A boolean value representing whether the main player has the target
	 *         player in their follower list.
	 */
	public abstract boolean getPlayerIsFollower(String sourcePlayerID, String targetPlayerID);

	/**
	 * Gets if the player (by the player id to check) is in the players blocked
	 * list.
	 * 
	 * @param sourcePlayerID ID for the main player (friend list owner)
	 * @param targetPlayerID ID for the target player.
	 * @return A boolean value representing whether the main player has the target
	 *         player in their blocked list.
	 */
	 ...
	 * 
	 * @param sourcePlayerID ID for the main player (friend list owner)
	 * @param targetPlayerID The player list entry to add under the following
	 *                       section.
	 */
	 ...
	 * 
	 * @param sourcePlayerID ID for the main player (friend list owner)
	 * @param targetPlayerID The player list entry to add under the followers
	 *                       section.
	 */
	...
	/**
	 * Gets the list of players ids that are blocked by this player.
	 * 
	 * @param sourcePlayerID ID for the main player (friend list owner)
	 */
	public abstract String[] getBlockedPlayers(String sourcePlayerID);
