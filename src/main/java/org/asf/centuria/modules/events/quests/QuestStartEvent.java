 ...
 * 
 */
public class QuestStartEvent extends AbstractQuestEvent {
	public QuestStartEvent(GameServer server, Player player, CenturiaAccount account, SmartfoxClient client,
