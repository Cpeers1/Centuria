package org.asf.centuria.packets.xt.gameserver.user;
...
public class UserTutorialCompletedPacket implements IXtPacket<UserTutorialCompletedPacket> {
	...
	@Override
	public UserTutorialCompletedPacket instantiate() {
		return new UserTutorialCompletedPacket();
	}
