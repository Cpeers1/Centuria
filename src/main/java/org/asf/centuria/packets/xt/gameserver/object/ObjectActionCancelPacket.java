...
public class ObjectActionCancelPacket implements IXtPacket<ObjectActionCancelPacket> {
	...
	@Override
	public ObjectActionCancelPacket instantiate() {
		return new ObjectActionCancelPacket();
	}
