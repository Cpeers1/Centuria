...
public class ObjectInfoAvatarLocalPacket implements IXtPacket<ObjectInfoAvatarLocalPacket> {
	...
	@Override
	public ObjectInfoAvatarLocalPacket instantiate() {
		return new ObjectInfoAvatarLocalPacket();
	}
