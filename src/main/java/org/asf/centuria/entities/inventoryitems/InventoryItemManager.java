...
/**
 * This class is responsible for holding a type register of all items. It
 * retrieves the items's class type from its inventory type.
 * 
 * @author Owenvii
 *
 */
public final class InventoryItemManager {
	...
	/**
	 * This method registers all items (Items marked with the Item Annotation) into
	 * the register.
	 * 
	 ...
	 */
	public static void registerAllItems() throws InstantiationException, IllegalAccessException,
		...
		for (var classObject : classes) {
			...
			Centuria.logger.debug(MarkerManager.getMarker("ITEMS"),
					"Loading item into item register: " + itemType.toString());
