...
public class PlayerSanctuaryController {
	...
	public static PlayerSanctuaryController newInstance(String ownerId)
	{
		try {
			...
			var classId = playerSanctuaryController.sanctuaryLookInventoryItem.getSanctuaryLookComponent().info.classInvId;
			var islandId = playerSanctuaryController.sanctuaryLookInventoryItem.getSanctuaryLookComponent().info.islandInvId;
			var houseId = playerSanctuaryController.sanctuaryLookInventoryItem.getSanctuaryLookComponent().info.houseInvId;
			
			playerSanctuaryController.sanctuaryClassInventoryItem = new SanctuaryClassItem();
			playerSanctuaryController.sanctuaryClassInventoryItem.fromJsonObject(accessor.getSanctuaryClassObject(classId));
