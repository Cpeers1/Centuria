...
/**
 * This class is responsible for holding a type register of all components. It
 * retrieves the component's class type from its component json name.
 * 
 * @author Owenvii
 *
 */
public final class ComponentManager {
	...
	/**
	 * This method registers all components (Items marked with the Component
	 * Annotation) into the register.
	 * 
	 ...
	 */
	public static void registerAllComponents() throws InstantiationException, IllegalAccessException,
		...
		for (var classObject : classes) {
			...
			Centuria.logger.debug(MarkerManager.getMarker("COMPONENTS"),
					"Loading component into component register: " + componentName);
