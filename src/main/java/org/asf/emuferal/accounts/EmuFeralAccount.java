...
public abstract class EmuFeralAccount {
    ...
    public boolean kick(String issuer, String reason) {
        ...
        System.out.println("Kicked " + getDisplayName() + ": " + (reason == null ? "Unspecified reason" : reason) + " (issued by " + issuerNm + ")");
    ...
    public void ban(String issuer, String reason) {
        ...
        System.out.println("Premanently banned " + getDisplayName() + ": " + (reason == null ? "Unspecified reason" : reason) + " (issued by " + issuerNm + ")");
    }
    ...
    public void tempban(int days, String issuer, String reason) {
        ...
        System.out.println("Temporarily banned " + getDisplayName() + ": " + (reason == null ? "Unspecified reason" : reason) + " (issued by " + issuerNm + ", unban in " + days + " days)");
    }
    ...
    public void mute(int days, int hours, int minutes, String issuer, String reason) {
        ...
        // Dispatch event
        EventBus.getInstance().dispatchEvent(new AccountMuteEvent(this, muteInfo.get("unmuteTimestamp").getAsLong(), issuer, reason));
        ...
        System.out.println("Muted " + getDisplayName() + ": " + (reason == null ? "Unspecified reason" : reason) + " (issued by " + issuerNm + ", unmute in " + days + " days, " + hours + " hours and " + minutes + " minutes)");
    }
    ...
    public void pardon(String issuer, String reason) {
        ...
        System.out.println("Pardoned " + getDisplayName() + ": " + (reason == null ? "Unspecified reason" : reason) + " (issued by " + issuerNm + ")");
    }
