...
import org.asf.emuferal.entities.Factory;
...
public abstract class InventoryItemComponent {
	 ...
	 * This should be the name the object is stored as under the components part of the inventory item.
	 ...
	 */
	public static <T extends InventoryItemComponent> InventoryItemComponent fromJson(Class<T> type, JsonObject jsonObject) throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
