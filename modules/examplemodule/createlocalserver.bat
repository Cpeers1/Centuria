@echo off
set git="https://github.com/SkySwimmer/EmuFeral.git"
set dir=%cd%

echo Updating standalone installation for testing...

echo Cloning git repository...
set tmpdir="%userprofile%\AppData\Local\Temp\build-emuferal-standalone-module"
...
copy /Y build\Installations\EmuFeral.jar "%dir%\libraries" >NUL
