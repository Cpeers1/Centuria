...
public class ConfirmRejectHandler2fa {

	/**
	 * Confirm reject button event (2fa)
	 * 
	...
	public static Mono<?> handle(String id, ButtonInteractionEvent event, GatewayDiscordClient gateway) {
		...
		if (uid.equals(str)) {
			...
			msg.content("Are you sure you wish to reject the login attempt?");

			// Add buttons
			msg.addComponent(ActionRow.of(Button.danger("dodeny2fa/" + uid + "/" + action, "Confirm"),
