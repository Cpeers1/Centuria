...
public class ConfirmEnable2fa {

	/**
	 * Confirm 'enable 2-factor authentication' handler
	 * 
		...
		if (uid.equals(str)) {
			...
			if (acc != null) {
				...
				InteractionApplicationCommandCallbackSpec.Builder msg = InteractionApplicationCommandCallbackSpec
						.builder();
				msg.content("Enable 2-factor authentication?");

				// Add buttons
				msg.addComponent(ActionRow.of(Button.success("doenable2fa/" + uid + "/" + gid, "Confirm"),
