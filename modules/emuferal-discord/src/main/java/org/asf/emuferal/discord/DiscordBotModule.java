...
import org.asf.emuferal.discord.handlers.api.ForgotPasswordHandler;
import org.asf.emuferal.discord.handlers.discord.BanHandler;
import org.asf.emuferal.discord.handlers.discord.CommandHandler;
import org.asf.emuferal.discord.handlers.discord.InteractionButtonHandler;
import org.asf.emuferal.discord.handlers.discord.InteractionModalHandler;
import org.asf.emuferal.discord.handlers.discord.InteractionSelectMenuHandler;
import org.asf.emuferal.discord.handlers.game.ModuleCommands;
import org.asf.emuferal.discord.handlers.game.AnnouncementHandlers;
import org.asf.emuferal.discord.handlers.game.GamePacketHandlers;
import org.asf.emuferal.discord.handlers.game.LoginEventHandler;
import org.asf.emuferal.discord.handlers.game.ModerationHandlers;
...
public class DiscordBotModule implements IEmuFeralModule {
	...
	public void preInit() {
		...
		EmuFeral.allowRegistration = false;
		...
		if (!configFile.exists()) {
			...
			config.addProperty("serverName", "EmuFeral");
						...
						ev = ev.then().and(gateway.on(MessageCreateEvent.class, event -> {
							...
							if (g != null) {
								...
								if (msg.startsWith("emuferal!")) {
									String cmd = msg.substring("emuferal!".length());
