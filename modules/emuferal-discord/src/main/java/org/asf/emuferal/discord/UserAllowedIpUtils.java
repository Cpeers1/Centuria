...
public class UserAllowedIpUtils {
	 ...
	 */
	public static boolean isAllowed(EmuFeralAccount account, String ip) {
	 ...
	 */
	public static String[] getAllowedIps(EmuFeralAccount account) {
		if (account.getPlayerInventory().containsItem("allowedips")) {
			// Load item
			JsonArray arr = account.getPlayerInventory().getItem("allowedips").getAsJsonArray();
	 ...
	 */
	public static void whitelistIp(EmuFeralAccount account, String ip) {
	 ...
	 */
	public static void removeFromWhitelist(EmuFeralAccount account, String ip) {
		if (isAllowed(account, ip)) {
			// Load list
			JsonArray arr = account.getPlayerInventory().getItem("allowedips").getAsJsonArray();
