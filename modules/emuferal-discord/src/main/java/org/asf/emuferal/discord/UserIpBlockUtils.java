...
public class UserIpBlockUtils {
	 ...
	 */
	public static boolean isBlocked(EmuFeralAccount account, String ip) {
	 ...
	 */
	public static String[] getBlockedIps(EmuFeralAccount account) {
		if (account.getPlayerInventory().containsItem("blockedips")) {
			// Load item
			JsonArray arr = account.getPlayerInventory().getItem("blockedips").getAsJsonArray();
	 ...
	 */
	public static void blockIp(EmuFeralAccount account, String ip) {
	 ...
	 */
	public static void unblockIp(EmuFeralAccount account, String ip) {
		if (isBlocked(account, ip)) {
			// Load list
			JsonArray arr = account.getPlayerInventory().getItem("blockedips").getAsJsonArray();
