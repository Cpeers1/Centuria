...
public class LinkUtils {
	...
	/**
	 * Generates a Centuria pairing code
	 * 
	...
	/**
	 * Checks if the given Centuria account is paired with any discord account
	 * 
	...
	/**
	 * Retrieves the discord account linked with a Centuria account
	 * 
	 * @param account Account to check
	...
	/**
	 * Pairs a discord account with a Centuria account
	 * 
	...
	public static void pairAccount(CenturiaAccount account, String userID, String address, boolean sendDM,
		...
		if (sendDM) {
			...
			try {
				...
				// Message content
				if (!isTransfer)
					msg.content("Successfully linked your Centuria account with your discord account!\n" + "\n"
					...
					msg.content("Successfully transferred your Centuria account to your new discord account!\n" + "\n"
	...
	/**
	 * Unpairs a discord account from a Centuria account
	 * 
	...
	public static void unpairAccount(CenturiaAccount account, String address, boolean sendDM) {
		...
		if (sendDM) {
			...
			try {
				...
				// Message content
				msg.content("Your account has just been unpaired from Centuria.\n" + "\n"
	...
	/**
	 * Checks if the given Discord account is paired with any Centuria account
	 * 
	...
	/**
	 * Retrieves a Centuria account by Discord UserID
	 * 
	 * @param userID Discord UserID to find the account for
	 * @return CenturiaAccount instance or null
	 */
	public static CenturiaAccount getAccountByDiscordID(String userID) {
		if (accountLinks.has(userID)) {
